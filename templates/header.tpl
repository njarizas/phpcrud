...
<html lang="es" style="height:100%;">
    <head>
        ...
        <script src="class/${view_folder}/js/sweetalert.min.js"></script>
    ...
    <body style="height:100%;">
        <div class="container" style="background-color:#EEE; min-height: 100%;">
            <div class="col-md-10 col-md-offset-1" style="background-color:#FFF; min-height: 95%;">
                <header> 
                    <img class="img-responsive pull-left" src="class/${view_folder}/images/logo.png" height="60" width="60" style="margin-right: 10px;">
                    <h3 style="display: inline-block;">SISTEMA DE INFORMACIÓN</h3>
                </header>
                <?php
                include('menu.php');
                ?>
